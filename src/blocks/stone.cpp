    ...
    GameObject3D getMesh(int FaceFlags) override
    {
        ...
        if((FaceFlags & BlockFace::BACK) == BlockFace::BACK){
            ...
            gameObject.verticies.insert(gameObject.verticies.end(), {
             {{0.0f, 0.0f, 1.0f}, getTextureCoord(1, 0, TextureCoordType::TOP_LEFT), BLOCK_SHADE_SIDE},
             {{1.0f, 0.0f, 1.0f}, getTextureCoord(1, 0, TextureCoordType::BOTTOM_LEFT), BLOCK_SHADE_SIDE},
        ...
        if((FaceFlags & BlockFace::BOTTOM) == BlockFace::BOTTOM){
            gameObject.verticies.insert(gameObject.verticies.end(), {
             {{0.0f, 0.0f, 1.0f}, getTextureCoord(1, 0, TextureCoordType::TOP_RIGHT), BLOCK_SHADE_BOTTOM},
             {{1.0f, 0.0f, 1.0f}, getTextureCoord(1, 0, TextureCoordType::BOTTOM_RIGHT), BLOCK_SHADE_BOTTOM},
        ...
        if((FaceFlags & BlockFace::TOP) == BlockFace::TOP){
            gameObject.verticies.insert(gameObject.verticies.end(), {
             ...
             {{0.0f, 1.0f, 0.0f}, getTextureCoord(1, 0, TextureCoordType::TOP_LEFT), BLOCK_SHADE_TOP},
             {{1.0f, 1.0f, 0.0f}, getTextureCoord(1, 0, TextureCoordType::BOTTOM_LEFT), BLOCK_SHADE_TOP},
            });
            gameObject.indicies.insert(gameObject.indicies.end(), {
                base + 3,
                base + 2,
        ...
        if((FaceFlags & BlockFace::FRONT) == BlockFace::FRONT){
            gameObject.verticies.insert(gameObject.verticies.end(), {
             ...
             {{1.0f, 1.0f, 0.0f}, getTextureCoord(1, 0, TextureCoordType::BOTTOM_RIGHT), BLOCK_SHADE_SIDE},
             {{0.0f, 1.0f, 0.0f}, getTextureCoord(1, 0, TextureCoordType::TOP_RIGHT), BLOCK_SHADE_SIDE}
            });
            gameObject.indicies.insert(gameObject.indicies.end(), {
                base, //+0
                base + 2,
