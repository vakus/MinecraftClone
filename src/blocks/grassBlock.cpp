...
public:
    ...
    GameObject3D getMesh(int FaceFlags) override
    {
        ...
        if((FaceFlags & BlockFace::BOTTOM) == BlockFace::BOTTOM){
            gameObject.verticies.insert(gameObject.verticies.end(), {
             {{0.0f, 0.0f, 1.0f}, getTextureCoord(3, 0, TextureCoordType::TOP_RIGHT), BLOCK_SHADE_BOTTOM},
             {{1.0f, 0.0f, 1.0f}, getTextureCoord(3, 0, TextureCoordType::BOTTOM_RIGHT), BLOCK_SHADE_BOTTOM},
             {{0.0f, 0.0f, 0.0f}, getTextureCoord(3, 0, TextureCoordType::TOP_LEFT), BLOCK_SHADE_BOTTOM},
             {{1.0f, 0.0f, 0.0f}, getTextureCoord(3, 0, TextureCoordType::BOTTOM_LEFT), BLOCK_SHADE_BOTTOM},
            });
