...
public:
    ...
    GameObject3D getMesh(int FaceFlags) override
    {
        GameObject3D gameObject{
            {/*top*/
             {{0.0f, 0.0f, 1.0f}, getTextureCoord(0, 0, TextureCoordType::TOP_LEFT), BLOCK_SHADE_TOP},
             {{1.0f, 0.0f, 1.0f}, getTextureCoord(0, 0, TextureCoordType::BOTTOM_LEFT), BLOCK_SHADE_TOP},
             ...
             {{1.0f, 0.0f, 1.0f}, getTextureCoord(0, 0, TextureCoordType::BOTTOM_RIGHT), BLOCK_SHADE_SIDE},
             ...
             {{0.0f, 1.0f, 0.0f}, getTextureCoord(0, 0, TextureCoordType::TOP_LEFT), BLOCK_SHADE_SIDE},
             ...
             {{1.0f, 1.0f, 0.0f}, getTextureCoord(0, 0, TextureCoordType::BOTTOM_RIGHT), BLOCK_SHADE_BOTTOM},
             {{0.0f, 1.0f, 0.0f}, getTextureCoord(0, 0, TextureCoordType::TOP_RIGHT), BLOCK_SHADE_BOTTOM}},
            {}};
